...
namespace AS.MfcHost
{
    ...
    /// would be processed in SdiWndManager by ToolStripMenuItem.Click or ToolStripButton.Click.
    ...
    public class SdiCommandComponent : Component, IExtenderProvider, ISupportInitialize
	{
        ...
        private SdiWndManager m_WndManager = null;
		...
		public SdiCommandComponent()
		{

			InitializeComponent();

            // create WndManager
            m_WndManager = SdiWndManager.CreateInstance();

        }

		public SdiCommandComponent(IContainer container):this()
		{
			if(container != null)
			{
				container.Add(this);
    ...
    /// </summary>
    public class HostInsertingComponentDesigner : ComponentDesigner
    {
        public override void Initialize(System.ComponentModel.IComponent component)
        {
            ...
            SdiCommandComponent UmlEditorComponent = component as SdiCommandComponent;
