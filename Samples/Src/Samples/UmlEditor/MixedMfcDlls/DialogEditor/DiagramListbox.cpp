   ...
   ============================================================*/
{
	...
	CFont chk;
	chk.CreateFont( lf.lfHeight, 0, 0, 0, FW_NORMAL, 0, 0, 0, DEFAULT_CHARSET, OUT_TT_ONLY_PRECIS, CLIP_DEFAULT_PRECIS, DEFAULT_QUALITY, DEFAULT_PITCH | FF_DECORATIVE, _T("Marlett") );
	dc->SelectObject( &chk );
	...
	dc->DrawText( _T("u"), rectTop, DT_VCENTER | DT_SINGLELINE | DT_CENTER );
	dc->DrawText( _T("u"), rectBottom, DT_VCENTER | DT_SINGLELINE | DT_CENTER );
