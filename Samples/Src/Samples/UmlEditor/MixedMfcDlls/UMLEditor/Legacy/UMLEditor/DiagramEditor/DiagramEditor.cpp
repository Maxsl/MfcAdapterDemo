   ...
   ============================================================*/
{
	...
	if( m_hWnd )
	{
		...
		if(rect.Width()>0 && rect.Height()>0)
		{
			...
			//TRACE("SetupScrollbars (width): Virtual size = %d, Client size = %d\n",
			//	(int)( static_cast< double >( GetVirtualSize().cx ) * GetZoom() ),rect.right);

		//	if( round( static_cast< double >( GetVirtualSize().cx ) * GetZoom() ) <= rect.right )
			if( (int)( static_cast< double >( GetVirtualSize().cx ) * GetZoom() ) <= rect.right )
			{
			...
			//TRACE("SetupScrollbars (height): Virtual size = %d, Client size = %d\n",
			//	(int)( static_cast< double >( GetVirtualSize().cy ) * GetZoom() ),rect.bottom);
		//	if( round( static_cast< double >( GetVirtualSize().cy ) * GetZoom() ) <= rect.bottom )
			if( (int)( static_cast< double >( GetVirtualSize().cy ) * GetZoom() ) <= rect.bottom )
			{
		...
		//	int width = round( static_cast< double >( GetVirtualSize().cx ) * GetZoom() );
			int width = (int)( static_cast< double >( GetVirtualSize().cx ) * GetZoom() );
			if( width > rect.right )
			{
				si.nMax = width;
				si.nPage = rect.right;
		...
		//	int height = round( static_cast< double >( GetVirtualSize().cy ) * GetZoom() );
			int height = (int)( static_cast< double >( GetVirtualSize().cy ) * GetZoom() );
			if( height > rect.bottom +1 )
			{
				si.nMax = height;
