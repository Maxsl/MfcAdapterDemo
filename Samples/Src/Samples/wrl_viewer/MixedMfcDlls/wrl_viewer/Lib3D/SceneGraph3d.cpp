...
// HasTexture
//********************************************
int CSceneGraph3d::HasTexture(TCHAR *name,
															int *index)
{
...
// SaveFile
//********************************************
int CSceneGraph3d::SaveFile(TCHAR *name)
{
	// Check
	if(NbObject() == 0)
	{
		AfxMessageBox(_T("This scene does not contain meshes"));
		return 0;
	}
	...
	{
		AfxMessageBox(_T("Error during writing header"));
		return 0;
	}
...
// SaveFileRaw
//********************************************
int CSceneGraph3d::SaveFileRaw(TCHAR *name)
{
	// Check
	if(NbObject() == 0)
	{
...
// Do not close file
//**********************************************
int CSceneGraph3d::WriteHeader(CStdioFile &file, TCHAR *name)
{	CFileException ex;
	...
	TRY
	{
		...
		file.WriteString(_T("# Produced by 3d Toolbox 1.0 (Pierre Alliez, CNET / DIH / HDM)\n\n"));
	}
