...
// Redirection
//********************************************
int CTexture::ReadFile(TCHAR *filename,
											 unsigned int width,
											 unsigned int height,
											 unsigned int depth)
{
...
// Size : 2^n x 2^m
//********************************************
int CTexture::ReadFileBMP(TCHAR *filename)
{
...
// Size : 2^n x 2^m
//********************************************
int CTexture::ReadFileRAW(TCHAR *filename,
													unsigned int width,
													unsigned int height,
													unsigned int depth)
{
...
// Redirection
//********************************************
int CTexture::SaveFile(TCHAR *filename)
{
	CString string = filename;
	string.MakeLower();
...
// SaveFileRAW
//********************************************
int CTexture::SaveFileRAW(TCHAR *filename)
{
...
// Accept only 24 bits
//********************************************
int CTexture::SaveFileBMP(TCHAR *filename)
{
	if(!IsValid())
		return 0;
...
int CTexture::LowerPowerOfTwo(int value)
{
	...
	while(1)
	{
		x = (int)pow(double(2),power);
		if(x >= value)
			return (int)pow(double(2),power-1);
		power++;
	}
