...
void CRowListView::OnInitialUpdate()
{
	...
	TRACE("ListCtrl:  window (HWND: 0x%8.8X)\n",ListCtrl.m_hWnd);
...
//******AS update start**************************//
void CRowListView::SetPreferredSize()
{
}		
CSize CRowListView::GetPreferredSize(CSize )
{
	return CSize(300,300);
}
void CRowListView::Scale(float scaleX,float )
{
}
//******AS update end****************************//
